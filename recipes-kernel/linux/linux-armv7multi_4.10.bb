...
SRC_URI:append:udooneo = "file://0002-ARM-drm-armada-add-fix-for-build-error-missing-heade.patch \
                         file://defconfig \
"

SRC_URI:append:nitrogen6x = "file://0001-imx6q-nitrogen6_max.dts-enable-spidev-on-ecspi5-disa.patch \
                             file://defconfig \
"
