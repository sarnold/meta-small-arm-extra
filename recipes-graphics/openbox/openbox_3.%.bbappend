...
#SRC_URI:append_rpi = "http://www.gentoogeek.org/files/rpi-backgrounds.tar.gz;name=backgrounds"
...
#PACKAGES:prepend_rpi = "openbox-backgrounds "

FILES:${PN}-gnome += "${datadir}/gnome/ ${datadir}/gnome-session"
#FILES:${PN}-backgrounds = "/usr/share/backgrounds/*"
FILES:${PN}-config += "${sysconfdir}/mini_x/*"
